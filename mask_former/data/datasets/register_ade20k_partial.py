...
def register_ade20k_2526(root):
    ...
    # train
    image_dir = os.path.join(root, "ADE20K_2526", "images")
    gt_dir = os.path.join(root, "ADE20K_2526", "annotations")
    name = "ade20k_2526_sem_seg_train"
...
def register_ade20k_weakly(root):
    ...
    # train
    image_dir = os.path.join(root, "ADE20K_weakly", "images")
    gt_dir = os.path.join(root, "ADE20K_weakly", "annotations")
    name = "ade20k_weakly_sem_seg_train"
